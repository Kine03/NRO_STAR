...
public class DataGame {
    ...
    public static byte vsMap = 15;
    public static byte vsSkill = 15;
    public static byte vsItem = 15;

    public static String LINK_IP_PORT = "BARCOLL:localhost:14445:0,0,0";
    private static final String MOUNT_NUM = "733:1,734:2,735:3,743:4,744:5,746:6,795:7,849:8,897:9,920:10,1092:11,1135:12,1148:13,1176:14"
            + ",1578:43,1577:45,1572:44";
    public static final Map MAP_MOUNT_NUM = new HashMap();

    private static final byte[] dart = FileIO.readFile("resources/louisgoku/update_data/dart");
    private static final byte[] arrow = FileIO.readFile("resources/louisgoku/update_data/arrow");
    private static final byte[] effect = FileIO.readFile("resources/louisgoku/update_data/effect");
    private static final byte[] image = FileIO.readFile("resources/louisgoku/update_data/image");
    private static final byte[] skill = FileIO.readFile("resources/louisgoku/update_data/skill");
    ...
    public static void requestMobTemplate(Session session, int id) 
    {
        ...
        Message msg;
           try {
            ...
            if ( id != 82 && id != 83 && id != 84 && id != 85 && id != 86 && id != 87 
                    && id != 88 && id != 89 && id != 91 && id != 92 && id != 93 ) {
    ...
    public static void sendDataImageVersion(Session session) {
        ...
        try {
            msg = new Message(-111);
            msg.writer().write(FileIO.readFile("resources/louisgoku/data_img_version/x" + session.zoomLevel + "/img_version"));
            session.doSendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Log.error(DataGame.class, e);
    ...
    public static void sendTileSetInfo(Session session) {
        ...
        try {
            msg = new Message(-82);
            msg.writer().write(FileIO.readFile("resources/louisgoku/map/tile_set_info"));
            session.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
        }
    ...
    public static void sendMapTemp(Session session, int id) {
        ...
        try {
            ...
            msg.writer().write(FileIO.readFile("resources/louisgoku/map/tile_map_data/" + id));
            session.sendMessage(msg);
            msg.cleanup();
        } catch (Exception e) {
            Log.error(DataGame.class, e);
