...
//                session.referral_points = rs.getInt("referral_points");
        ...
        try {
            ...
            try {
                if (rs.next()) {
                    ...
                    player.diem_tranh_ngoc = rs.getInt("diem_tranh_ngoc");
                    player.event.setEventPoint(evPoint);
                    player.lvpet = rs.getInt("lvpet");
                    ...
                    player.diemmaydam = rs.getInt("diemmaydam");
                    ...
                    //data res skill 9
                    dataArray = (JSONArray) JSONValue.parse(rs.getString("data_newSkill"));
                    player.newSkill.TypePaint = Byte.parseByte(String.valueOf(dataArray.get(0)));
                    player.newSkill.TypeItem = Byte.parseByte(String.valueOf(dataArray.get(1)));
                    player.newSkill.isFly = Boolean.valueOf(String.valueOf(dataArray.get(2)));
                    dataArray.clear();
                    ...
                    dataArray = (JSONArray) jv.parse(rs.getString("point_hanhtrang"));
                    ...
                    if (dataArray.size() >= 27) {
                        ...
                        timebuax5 = Integer.parseInt(dataArray.get(15).toString());
                        timebuax2dt = Integer.parseInt(dataArray.get(16).toString());
                        time4la = Integer.parseInt(dataArray.get(17).toString());
                        timebinhcommeson = Integer.parseInt(dataArray.get(18).toString());
                        timeCuongbao = Integer.parseInt(dataArray.get(19).toString());
                        timeruotden = Integer.parseInt(dataArray.get(20).toString());
                        timeMa = Integer.parseInt(String.valueOf(dataArray.get(21)));
                        timeDoi = Integer.parseInt(String.valueOf(dataArray.get(22)));
                        timeBo = Integer.parseInt(String.valueOf(dataArray.get(23)));
//                        timeBo = Integer.parseInt(String.valueOf(dataArray.get(23)));
                        timeSMTA = Integer.parseInt(String.valueOf(dataArray.get(26)));
                    ...
                    player.itemTime.lastTimeBanhChung = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeBanhChung1);
                    player.itemTime.lastTimeBanhTet = System.currentTimeMillis() - (ItemTime.TIME_EAT_MEAL - timeBanhTet1);

                    player.itemTime.lastTimebuax5 = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timebuax5);
                    player.itemTime.lastTimebuax2dt = System.currentTimeMillis() - (ItemTime.TIME_ITEM_X2_DT - timebuax2dt);
                    player.itemTime.lastTime4la = System.currentTimeMillis() - (ItemTime.TIME_ITEM_X2_DT - time4la);
                    player.itemTime.lastTimebinhcommeson = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timebinhcommeson);
                    player.itemTime.lastTimeCuongbao = System.currentTimeMillis() - (ItemTime.TIME_MAY_DO - timeCuongbao);
                    player.itemTime.lastTimeruotden = System.currentTimeMillis() - (ItemTime.TIME_ruotden - timeruotden);
                    player.itemTime.lastTimeMaTroi = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeMa);
                    player.itemTime.lastTimeDoiNhi = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeDoi);
                    player.itemTime.lastTimeBoXuong = System.currentTimeMillis() - (ItemTime.TIME_ITEM - timeBo);
                    player.itemTime.lastTimeUseNhanMaPhap = System.currentTimeMillis() - (ItemTime.TIME_NHAN_MA_PHAP - timeMaPhap);
                    player.itemTime.lastTimeUseNhanLinhGioi = System.currentTimeMillis() - (ItemTime.TIME_NHAN_LINH_GIOI - timeLinhGioi);
                    player.itemTime.lastTimeSMTA = System.currentTimeMillis() - (ItemTime.TIME_SMTA - timeSMTA);
                    ...
                    player.itemTime.isUsebuax5 = timebuax5 != 0;
                    player.itemTime.isUsebuax2dt = timebuax2dt != 0;
                    player.itemTime.isUse4la = time4la != 0;
                    player.itemTime.isUsebinhcommeson = timebinhcommeson != 0;
                    player.itemTime.isUseCuongbao = timeCuongbao != 0;
                    player.itemTime.isUseruotden = timeruotden != 0;
                    player.itemTime.isMaTroi = timeMa != 0;
                    player.itemTime.isDoiNhi = timeDoi != 0;
                    player.itemTime.isBoXuong = timeBo != 0;
                    player.itemTime.isUseNhanMaPhap = timeMaPhap != 0;
                    player.itemTime.isUseNhanLinhGioi = timeLinhGioi != 0;
                    player.itemTime.isUseSMTA = timeSMTA != 0;
                    ...
                    dataObject.clear();
                    //data mốc nạp
                    dataArray = (JSONArray) JSONValue.parse(rs.getString("nap_vip"));
                    player.vip = Byte.parseByte(dataArray.get(0).toString());
                    player.timevip = Long.parseLong(dataArray.get(1).toString());
                    player.pointSb = Integer.parseInt(dataArray.get(2).toString());
                    player.mocnap = Integer.parseInt(dataArray.get(3).toString());
                    player.mocsanboss = Integer.parseInt(dataArray.get(4).toString());
                    dataArray.clear();

                    //data linh thus
                    dataObject = (JSONObject) JSONValue.parse(rs.getString("data_linhthu_egg"));
                    Object timeLinhThu = dataObject.get("create_time_linhthu");
                    if (timeLinhThu != null) {
                        player.LinhThuEgg = new TrungLinhThu(player, Long.parseLong(String.valueOf(timeLinhThu)),
                                Long.parseLong(String.valueOf(dataObject.get("time_done_linhthu"))));
                    }
                    dataObject.clear();
                    ...
                    if (itemsBody.get(10).isNotNullItem()) {
                        MiniPet.callMiniPet(player, (player.inventory.itemsBody.get(10).template.id));
                    }

                    if (itemsBody.get(9).isNotNullItem()) {
                        PetFollow pet = PetFollowManager.gI().findByID(itemsBody.get(9).getId());
