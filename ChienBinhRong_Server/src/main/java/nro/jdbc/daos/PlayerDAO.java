...
public class PlayerDAO {
    ...
    public static void createNewPlayer(Connection con, int userId, String name, byte gender, int hair) {
        ...
        try {
            ...
            dataItemTime.add(0);//0
            dataItemTime.add(0);//1
            dataItemTime.add(0);//2
            dataItemTime.add(0);//3
            dataItemTime.add(0);//4
            dataItemTime.add(0);//5
            dataItemTime.add(0);//6
            dataItemTime.add(0);//7
            dataItemTime.add(0);//8
            dataItemTime.add(0);//9
            dataItemTime.add(0);//10
            dataItemTime.add(0);//11
            dataItemTime.add(0);//12
            dataItemTime.add(0);//13
            dataItemTime.add(0);//14
            dataItemTime.add(0);//15
            dataItemTime.add(0);//16
            dataItemTime.add(0);//17
            dataItemTime.add(0);//18
            dataItemTime.add(0);//19
            dataItemTime.add(0);//20
            dataItemTime.add(0);//21
            dataItemTime.add(0);//22
            dataItemTime.add(0);//23
            dataItemTime.add(0);//24
            dataItemTime.add(0);//25
            dataItemTime.add(0);//26
            dataItemTime.add(0);//27
            ...
            JSONArray napvip = new JSONArray();
            napvip.add(0);
            napvip.add(0);
            napvip.add(0);
            napvip.add(0);
            napvip.add(0);
            String napVip = napvip.toJSONString();

            String linhthuEgg = "{}";

            JSONArray Newskill = new JSONArray();
            Newskill.add(0);//typepaint
            Newskill.add(0);//typeitem
            Newskill.add(false);//isFly

            String NewSkill = Newskill.toJSONString();
            ps = con.prepareStatement("insert into player"
                    ...
                    + "data_black_ball, thoi_vang, data_side_task,achivements,lastimelogin, nap_vip,data_linhthu_egg,data_newSkill) "
                    + "values (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");//3 dấu hỏi
            ...
            ps.setString(33, napVip);
            ps.setString(34, linhthuEgg);
            ps.setString(35, NewSkill);
        ...
        try {
            ...
            if (player.loaded) {
                ...
                try {
                    ...
                    //data chỉ số hành trang
                    JSONArray Point2 = new JSONArray();
                    Point2.add(player.nPoint.hpMax);
                    Point2.add(player.nPoint.mpMax);
                    Point2.add(player.nPoint.dame);
                    String point2 = Point2.toJSONString();
                    ...
                    dataItemTime.add(player.itemTime.isUseBanhChung ? (ItemTime.TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastTimeBanhChung)) : 0);
                    ...
                    dataItemTime.add(player.itemTime.isUsebuax5 ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimebuax5)) : 0);
                    dataItemTime.add(player.itemTime.isUsebuax2dt ? (ItemTime.TIME_ITEM_X2_DT - (System.currentTimeMillis() - player.itemTime.lastTimebuax2dt)) : 0);
                    dataItemTime.add(player.itemTime.isUse4la ? (ItemTime.TIME_ITEM_X2_DT - (System.currentTimeMillis() - player.itemTime.lastTime)) : 0);
                    dataItemTime.add(player.itemTime.isUsebinhcommeson ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimebinhcommeson)) : 0);
                    dataItemTime.add(player.itemTime.isUseCuongbao ? (ItemTime.TIME_MAY_DO - (System.currentTimeMillis() - player.itemTime.lastTimeCuongbao)) : 0);
                    dataItemTime.add(player.itemTime.isUseruotden ? (ItemTime.TIME_ruotden - (System.currentTimeMillis() - player.itemTime.lastTimeruotden)) : 0);
                    dataItemTime.add(player.itemTime.isMaTroi ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeMaTroi)) : 0);
                    dataItemTime.add(player.itemTime.isDoiNhi ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeDoiNhi)) : 0);
                    dataItemTime.add(player.itemTime.isBoXuong ? (ItemTime.TIME_ITEM - (System.currentTimeMillis() - player.itemTime.lastTimeBoXuong)) : 0);
                    dataItemTime.add(player.itemTime.isUseNhanMaPhap ? (ItemTime.TIME_NHAN_MA_PHAP - (System.currentTimeMillis() - player.itemTime.lastTimeUseNhanMaPhap)) : 0);
                    dataItemTime.add(player.itemTime.isUseNhanLinhGioi ? (ItemTime.TIME_NHAN_LINH_GIOI - (System.currentTimeMillis() - player.itemTime.lastTimeUseNhanLinhGioi)) : 0);
                    dataItemTime.add(player.itemTime.isUseSMTA ? (ItemTime.TIME_SMTA - (System.currentTimeMillis() - player.itemTime.lastTimeSMTA)) : 0);
                    ...
                    //data napvip
                    JSONArray dataNapVip = new JSONArray();
                    dataNapVip.add(player.vip);
                    dataNapVip.add(player.timevip);
                    dataNapVip.add(player.pointSb);
                    dataNapVip.add(player.mocnap);
                    dataNapVip.add(player.mocsanboss);
                    String NapVip = dataNapVip.toJSONString();
                    dataNapVip.clear();

                    //data linh thú
                    JSONObject datalinhthu = new JSONObject();
                    if (player.LinhThuEgg != null) {
                        datalinhthu.put("create_time_linhthu", player.LinhThuEgg.lastTimeCreate);
                        datalinhthu.put("time_done_linhthu", player.LinhThuEgg.timeDone);
                    }
                    String linhthuEgg = datalinhthu.toJSONString();
...
//                    }
                    ...
                    JSONArray Newskill = new JSONArray();
                    Newskill.add(player.newSkill.TypePaint);
                    Newskill.add(player.newSkill.TypeItem);
                    Newskill.add(player.newSkill.isFly);
                    String NewSkill = Newskill.toJSONString();
                    ...
                    try {
                        ps = connection.prepareStatement("UPDATE player SET head = ?, have_tennis_space_ship = ?,"
                                ...
                                + "challenge = ?, sk_tet = ?, buy_limit = ?, moc_nap = ?, achivements = ?, reward_limit = ?, dhtime = ?, dhtime2 = ?, dhtime3 = ?, dhtime4 = ?, dhtime5 = ? ,killWhis = ?, MaBaoVe = ?, levelKillWhis = ?,timeKillWhis = ?, diemmaydam = ?"
                                + ",checkNhanQua = ?,point_hanhtrang = ?, lvpet = ?, nap_vip = ?,data_linhthu_egg = ?, chuyen_sinh = ?, data_newSkill = ? ,diem_skien = ?, diem_tranh_ngoc = ? WHERE id = ?");
                        ...
                        ps.setInt(51, player.diemmaydam);
                        ps.setLong(50, player.timeKillWhis);
                        ps.setString(52, checkNhanQua);
                        ps.setString(53, point2);
                        ps.setInt(54, player.lvpet);
                        ps.setString(55, NapVip);
                        ps.setString(56, linhthuEgg);
                        ps.setString(57, ChuyenSinh);
                        ps.setString(58, NewSkill);
                        ps.setInt(59, player.diem_skien);
                        ps.setInt(60, player.diem_tranh_ngoc);
                        ps.setInt(61, (int) player.id);
                        ps.executeUpdate();
                        if (updateTimeLogout) {
                            AccountDAO.updateAccountLogout(player.getSession());
                        }
                    } catch (Exception e) {
                        System.out.println("Lỗi save player: " + player.name);
                        e.printStackTrace();
                    } finally {
                        try {
                            ps.close();
...
//                            e.printStackTrace();
    ...
    public static void subVND2(Player player, int ruby) {
        PreparedStatement ps = null;
        try (Connection con = DBService.gI().getConnectionForSaveData();) {
    ...
    public static void subReferral_points(Player player, int num) {
        PreparedStatement ps = null;
        try (Connection con = DBService.gI().getConnectionForSaveData();) {
            ps = con.prepareStatement("update account set referral_points = (referral_points - ?) where id = ?");
            ps.setInt(1, num);
            ps.setInt(2, player.getSession().userId);
            player.getSession().referral_points -= num;
            ps.executeUpdate();
        } catch (Exception e) {
            Log.error(PlayerDAO.class, e, "Lỗi update referral_points " + player.name);
        } finally {
            try {
                ps.close();
            } catch (SQLException ex) {
    ...
    public static void subVndBarCong(Player player, int num) {
        PreparedStatement ps = null;
        try (Connection con = DBService.gI().getConnectionForSaveData();) {
            ps = con.prepareStatement("update account set vnd = (vnd + ?) where id = ?");
            ps.setInt(1, num);
