...
//    }
    ...
    public void loadMoData(Session session, int id) {
     ...
     public void loadEffectData(Session session, int id, int... idtemp) {
      int idT = id;
...
//            byte[] effData;
//            byte[] effImg;
//            effData = FileIO.readFile("resources/Eff/effect/x" + session.zoomLevel + "/data/DataEffect_" + idT);
//            effImg = FileIO.readFile("resources/Eff/effect/x" + session.zoomLevel + "/img/ImgEffect_" + idT + ".png");
//            if (id == 25) {
