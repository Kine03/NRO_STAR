...
public class SkillUtil {
    ...
    public static int getPercentKiMonkey(int level) { //tỉ lệ ki khỉ cộng thêm v
        return (level + 3) * 10;
    }

    public static int getPercentDameMonkey(int level) { //tỉ lệ dame khỉ cộng thêm v
        return (level * 3);
    }
...
//        return 10000;
    ...
    public static Skill getSkillByItemID(Player pl, int tempId) {
        ...
        } else if (tempId >= 1523 && tempId <= 1537) {
