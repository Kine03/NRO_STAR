                    ...
                    TimerTask OpenDHVT = new TimerTask() {
                        public void run() {
                            ...
                            for (int i = 0; i < DaiHoiVoThuatManager.gI().lstIDPlayers.size(); i++) {
                                ...
                                if (_p != null && _p.getSession() != null && _p.zone.map.mapId == 183) {
                            ...
                            if (p11.zone.map.mapId != 51) {
                                ...
                                if (!p11.isDie() && !p22.isDie()) {
                                    ...
                                    if (p11.nPoint.hp >= p22.nPoint.hp) {
                                        ...
                                        ChangeMapService.gI().changeMapInYard(p11, 183, -1, -1);
                                        Service.getInstance().hsChar(p22, 1, 1);
                                        ChangeMapService.gI().changeMapInYard(p22, 183, -1, -1);
        ...
        TimerTask winDHVT = new TimerTask() {
            public void run() {
                if (pW != null && pW.getSession() != null) {
                    ...
                    ChangeMapService.gI().changeMapInYard(pW, 183, -1, -1);
                }
                if (pL != null && pL.getSession() != null) {
                    ...
                    ChangeMapService.gI().changeMapInYard(pL, 183, -1, -1);
