...
public class BlackBallWar {
    ...
    public static final int COST_X3 = 1;
    public static final int COST_X5 = 3;
    public static final int COST_X7 = 5;
...
//    public static final byte SECOND_CLOSE = 0;
    ...
    private void win(Player player) {
        ...
        List<Player> playersMap = new ArrayList<>(player.zone.getPlayers()); // ← Copy danh sách
        for (Player pl : playersMap) {
            kickOutOfMap(pl); // Không gây lỗi vì duyệt danh sách độc lập
        }
    }
