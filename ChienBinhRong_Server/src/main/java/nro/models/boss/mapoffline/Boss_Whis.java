...
public class Boss_Whis extends FutureBoss {
    ...
    public Boss_Whis(int bossID, BossData bossData, Zone zone, int x, int y, Player player) throws Exception {
        ...
        this.location.x = x;
        this.location.y = y;
        this.nPoint.hpMax += player.levelKillWhis * 10000000;
        this.nPoint.hpg += player.levelKillWhis * 10000000;
        this.nPoint.mpg += player.levelKillWhis * 10000000;
        this.nPoint.mpMax += player.levelKillWhis * 10000000;
        this.nPoint.dame += player.levelKillWhis * 10000;
