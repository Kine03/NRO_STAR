 ...
 */
public class Topmaydam {

    @Getter
    private List<Player> list = new ArrayList<>();
    private static final Topmaydam INSTANCE = new Topmaydam();

    public static Topmaydam getInstance() {
        return INSTANCE;
    }
    ...
    public void load() {
        ...
        try (Connection con = DBService.gI().getConnectionForGetPlayer(); PreparedStatement ps = con.prepareStatement("SELECT * FROM player ORDER BY player.diemmaydam DESC LIMIT 100"); ResultSet rs = ps.executeQuery()) {
